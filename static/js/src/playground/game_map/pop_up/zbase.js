...
export class PopUp extends AcGameObject {
  ...
  add_POS() {
    ...
    this.POS["pop_up_button_click_position"] = [[0.53, 0.51, 0.8, 0.58]];
  }
  ...
  load_image() {
    ...
    this.home_button_icon.src =
      "/static/image/playground/popupbuttons-sheet0.png";
    this.next_button_icon = new Image();
    this.next_button_icon.src =
      "/static/image/playground/popupbuttons-sheet1.png";

    this.pop_up_success_img = new Image();
    this.pop_up_success_img.src =
      "/static/image/playground/resultphoto-sheet0.png";
    this.pop_up_fail_img = new Image();
    this.pop_up_fail_img.src =
      "/static/image/playground/resultphoto-sheet1.png";

    this.images = [
      this.pop_up_background,
      this.shop_skill_items,
      this.button_background,
      this.next_button_icon,
      this.pop_up_fail_img,
      this.home_button_icon,
    ];
  }
