...
export class Shop extends AcGameObject {
  ...
  load_image() {
    ...
    this.shop_skill_price_background.src =
      "/static/image/playground/pricebg-sheet0.png";
  ...
  use_item_control_player_behavior_in_shop(i) {
    ...
    } else if (this.shop_skill_is_selling[i]) {
      // 购买技能需要判定技能是否在售
      // 玩家买了一个技能！
  ...
  // 绘制正在售卖的技能的价格背景板
  draw_shop_skill_price_background(
    canvas,
    icon_pos,
    shop_item_bg_x,
    shop_item_bg_y
    ...
    this.ctx.drawImage(
      ...
      canvas.width / 2 +
        canvas.scale *
          (icon_pos[2] * shop_item_bg_x + (icon_pos[2] - img.width) / 2),
      canvas.height / 2 +
        canvas.scale *
          (icon_pos[3] * shop_item_bg_y + (icon_pos[3] - img.height)),
  ...
  draw_shop_skill_sale_item(canvas, i) {
    ...
    this.ctx.drawImage(
      ...
      canvas.width / 2 +
        canvas.scale *
          (icon_pos[2] * shop_item_bg_x +
            (icon_pos[2] - skill_icon_pose[2]) / 2),
      canvas.height / 2 +
        canvas.scale *
          (icon_pos[3] * shop_item_bg_y +
            (icon_pos[3] - skill_icon_pose[3]) / 2 -
            this.shop_skill_price_background.height / 3),
  ...
  // 绘制技能售卖处图标背景
  draw_shop_skill_sale_item_background(
    canvas,
    icon_pos,
    shop_item_bg_x,
    shop_item_bg_y
