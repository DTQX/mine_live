...
export class GameMap extends AcGameObject {
  constructor(root, playground) {
    ...
    this.game_background = new GameBackground(
      this.playground,
      this.game_background_ctx
    );
    this.score_number = new ScoreNumber(
      this.playground,
      this.game_score_number_ctx,
      "game map"
    );
  ...
  start_new_level() {
    this.time_left = 100000; // 设定新一局游戏的时长
